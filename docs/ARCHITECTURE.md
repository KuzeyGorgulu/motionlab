...
- `src/export/scientificData.ts`, `graphSvg.ts`, and `download.ts` derive interoperable data, render standalone graphs, and perform the final browser download without duplicating analysis formulas.
